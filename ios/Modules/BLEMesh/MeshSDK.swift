...
extension MeshSDK {
  public func getProvisionedDevices(callback: @escaping LocalProvisionedResultCallback) {
  ...
  public func getProvisionedNodes(callback: @escaping LocalProvisionedDevicesCallback) {
...
// MARK: - 对设备发送控制指令
extension MeshSDK {
  public func getQuadruples(uuid: String, callback: @escaping QuadruplesResultCallback) {
    meshNetworkManager.delegate = self
  ...
  public func setGenericOnOff(uuid: String, isOn: Bool, callback: @escaping GenericOnOffStatusCallback) {
    meshNetworkManager.delegate = self
  ...
  public func setLightProperties(uuid: String, c: Int, w: Int, r: Int, g: Int, b: Int, callback: @escaping LightPropertyStatusCallback) {
    meshNetworkManager.delegate = self
  ...
  public func sendMeshMessage(uuid: String, element: Int, model: Int, opCode: String, value: String, callback: @escaping MeshMessageSendCallback) {
...
extension MeshSDK {
  public func resetNode(uuid: String, callback: @escaping ResetNodeCallback) {
...
extension MeshSDK {
  public func bindApplicationKeyForNode(appKey: String, uuid: String, callback: @escaping BindApplicationKeyForNodeCallback) {
  ...
  public func bindApplicationKeyForBaseModel(appKey: String, uuid: String, callback: @escaping BindApplicationKeyForBaseModelCallback) {
  ...
  public func bindApplicationKeyForCustomModel(appKey: String, uuid: String, callback: @escaping BindApplicationKeyForCustomModelCallback) {
...
extension MeshSDK: ProvisioningDelegate {
  ...
  public func provision(identifier: String, networkKey: String, callback: @escaping ProvisioningStatusCallback) {
...
extension MeshSDK: CBCentralManagerDelegate {
  ...
  public func checkPermission(callback : @escaping CheckPermissionCallback) {
  ...
  public func startScan(type: String, callback: @escaping DisposedScanResultReadableCallback) {
...
//  meshApllication
//
//  Created by changyh on 2020/2/12.
